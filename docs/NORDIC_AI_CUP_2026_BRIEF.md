<!-- Original Nordic AI Cup 2026 competition brief from the organisers (Ambolt AI), preserved verbatim.
     Moved here from the repository root when the root README became a project overview. -->
