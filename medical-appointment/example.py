...
from medapp.answerer import SpanRefiningAnswerer, build_answerer
...
_answerer = SpanRefiningAnswerer(
    build_answerer(settings),
    settings.span_pad_start_seconds,
    settings.span_pad_end_seconds,
)
